...
from Bert4Rec.encoder._attention import (ConfMultiHeadAttention,
                                         MultiHeadAttention)
from Bert4Rec.encoder._feed_forward_layer import (ConfFeedForwardLayer,
                                                  FeedForwardLayer)
from Bert4Rec.normalize._drop_residual_normalize_layer import (
    ConfDropResidaulNormalizeLayer, DropResidualNormalizeLayer)
...
class EncoderLayer(pl.LightningModule):
    ...
    def __init__(self, c: ConfEncoderLayer):
        ...
        self.drop_residual_norm_layer_1 = DropResidualNormalizeLayer(
            c.conf_drop_redsual_norm_layer
        )
